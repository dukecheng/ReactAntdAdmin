...
export default class FullScreen extends React.Component {
	...
	render() {
		return <Icon style={{ fontSize: '20px', cursor: 'pointer', color: '#ffffff' }} className="fullscreen" component={this.state.isFullScreen ? FullscreenExitOutlined : FullscreenOutlined} onClick={this.handleFullScrren} />;
	}
}
